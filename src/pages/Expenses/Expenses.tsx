...
import personTree from '../../assets/png/person3.png';
      ...
      <div className={styles.expensesCard}>
        <section className={styles.expensesOverview}>
          <div className={styles.expensesHeader}>
            <h3 className={styles.expensesTitle}>Expenses</h3>
            <div className={styles.expensesActions}>
              <div className={styles.personImages}>
                <img src={personOne} alt='person' className={styles.personOne}></img>
                <img src={personTwo} alt='person' className={styles.personTwo}></img>
                <img src={personTree} alt='person' className={styles.personThree}></img>
              </div>
              <button>
                ...
                <div className={styles.spendCategoryBar}>
                  <div
                    style={{
                      width: `${
                        (category.price /
                          spendCategories.reduce((acc, current) => acc + current.price, 0)) *
                        100
                      }%`,
                    }}
